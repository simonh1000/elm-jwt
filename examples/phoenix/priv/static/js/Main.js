...
var _user$project$Jwt$createRequestObject = F5(
...
var _user$project$Jwt$createRequest = F4(
	function (method, token, url, body) {
		return function (_p0) {
			return _elm_lang$http$Http$request(
				A5(_user$project$Jwt$createRequestObject, method, token, url, body, _p0));
		};
	});
...
var _user$project$Jwt$getTokenBody = function (token) {
	var processor = function (_p3) {
		return A2(
			_elm_lang$core$List$map,
			_user$project$Jwt$fixlength,
			A2(
				_elm_lang$core$String$split,
				'.',
				_user$project$Jwt$unurl(_p3)));
	};
	var _p4 = A2(
...
var _user$project$Jwt$decodeToken = function (dec) {
	return function (_p5) {
		return A2(
			...
			function (_p6) {
				return A2(
					...
					_user$project$Jwt$TokenDecodeError,
			...
			A2(
				...
				_user$project$Jwt$getTokenBody(_p5)));
	};
};
...
var _user$project$Jwt$checkUnacceptedToken = F2(
	function (token, now) {
		var _p8 = A2(_user$project$Jwt$isExpired, now, token);
		if (_p8.ctor === 'Ok') {
			if (_p8._0 === true) {
...
var _user$project$Jwt$checkTokenExpiry = function (token) {
	return A2(
		_elm_lang$core$Task$andThen,
		function (_p9) {
			return _elm_lang$core$Task$succeed(
				A2(_user$project$Jwt$checkUnacceptedToken, token, _p9));
		},
...
var _user$project$Jwt$promote401 = function (err) {
	...
	if (_p10.ctor === 'BadStatus') {
		return _elm_lang$core$Native_Utils.eq(_p10._0.status.code, 401) ? _user$project$Jwt$Unauthorized : _user$project$Jwt$HttpError(err);
	} else {
		return _user$project$Jwt$HttpError(err);
	}
};
var _user$project$Jwt$send = F2(
	function (msgCreator, req) {
		var conv = function (fn) {
			return function (_p11) {
				return fn(
					A2(_elm_lang$core$Result$mapError, _user$project$Jwt$promote401, _p11));
			};
		};
		return A2(
...
var _user$project$Jwt$handleError = F2(
	function (token, err) {
		var _p12 = _user$project$Jwt$promote401(
			A2(_elm_lang$core$Debug$log, '', err));
		if (_p12.ctor === 'Unauthorized') {
			return _user$project$Jwt$checkTokenExpiry(token);
		} else {
			return _elm_lang$core$Task$succeed(
			...
			A2(
				...
				function (_p13) {
					return A2(
						...
						A2(_user$project$Jwt$handleError, token, _p13));
				},
				A2(
					_elm_lang$core$Task$map,
...
var _user$project$Decoders$data2Decoder = _elm_lang$core$Json_Decode$succeed('success');
...
var _user$project$App$errorDecoder = A2(_elm_lang$core$Json_Decode$field, 'error', _elm_lang$core$Json_Decode$value);
			...
			case 'Unauthorized':
				return {
					...
					_1: A2(
						_elm_lang$core$Task$perform,
						msgCreator,
						_user$project$Jwt$checkTokenExpiry(token))
				};
			case 'TokenExpired':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
...
var _user$project$App$getWithNoResponse = function (token) {
	var req = A5(
		_user$project$Jwt$createRequestObject,
		'GET',
		token,
		'/api/data_error',
...
var _user$project$App$NonJsonResponse = function (a) {
	return {ctor: 'NonJsonResponse', _0: a};
};
var _user$project$App$tryUpdateRoute = function (token) {
	var req = A5(
		_user$project$Jwt$createRequestObject,
		'PUT',
		token,
	...
	return A2(
		_user$project$Jwt$send,
		_user$project$App$NonJsonResponse,
		_elm_lang$http$Http$request(
			_elm_lang$core$Native_Utils.update(
				req,
				{expect: _elm_lang$http$Http$expectString})));
...
var _user$project$App$update = F2(
	function (message, model) {
		var _p5 = A2(_elm_lang$core$Debug$log, 'update', message);
		switch (_p5.ctor) {
			case 'FormInput':
				var _p7 = _p5._1;
				var _p6 = _p5._0;
			...
			case 'TryRouteWithNoJsonResponse':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
					...
					_1: A2(
						_elm_lang$core$Maybe$withDefault,
						_elm_lang$core$Platform_Cmd$none,
						A2(_elm_lang$core$Maybe$map, _user$project$App$tryUpdateRoute, model.token))
				};
			case 'LoginResult':
				var _p8 = _p5._0;
				if (_p8.ctor === 'Ok') {
				...
				if (_p11.ctor === 'Ok') {
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								msg: _elm_lang$core$Basics$toString(_p11._0)
							}),
						{ctor: '[]'});
				} else {
					return A3(_user$project$App$failHandler_, _user$project$App$ServerFail_, _p11._0, model);
				}
			default:
...
var _user$project$App$TryRouteWithNoJsonResponse = {ctor: 'TryRouteWithNoJsonResponse'};
					...
					_1: {
						...
						_0: function () {
							...
							if (_p12.ctor === 'Nothing') {
								...
								var token = A2(_user$project$Jwt$decodeToken, _user$project$Decoders$tokenDecoder, _p12._0);
								return A2(
									_elm_lang$html$Html$div,
									{ctor: '[]'},
									{
											...
											_1: {
												...
												_1: {
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('Try route with Error'),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														_0: A2(
															_elm_lang$html$Html$button,
															{
																...
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Events$onClick(_user$project$App$TryRouteWithNoJsonResponse),
																	_1: {ctor: '[]'}
																}
															},
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text('Try api route that returns no json'),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Jwt.JwtError":{"args":[],"tags":{"TokenDecodeError":["String"],"TokenExpired":[],"Unauthorized":[],"HttpError":["Http.Error"],"TokenProcessingError":["String"],"TokenNotExpired":[]}},"App.Msg":{"args":[],"tags":{"NonJsonResponse":["Result.Result Jwt.JwtError String"],"TryToken":[],"TryInvalidToken":[],"ErrorRouteResult":["Result.Result Jwt.JwtError String"],"TryErrorRoute":[],"GetResult":["Result.Result Jwt.JwtError String"],"LoginResult":["Result.Result Http.Error String"],"FormInput":["App.Field","String"],"ServerFail_":["Jwt.JwtError"],"Login":[],"TryRouteWithNoJsonResponse":[]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"App.Field":{"args":[],"tags":{"Uname":[],"Pword":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"}},"message":"App.Msg"},"versions":{"elm":"0.18.0"}});
}
