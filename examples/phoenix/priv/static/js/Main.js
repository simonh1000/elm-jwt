...
var _user$project$App$PostFail = function (a) {
	return {ctor: 'PostFail', _0: a};
};
var _user$project$App$PostSucess = function (a) {
	return {ctor: 'PostSucess', _0: a};
};
var _user$project$App$LoginFail = function (a) {
	return {ctor: 'LoginFail', _0: a};
};
var _user$project$App$LoginSuccess = function (a) {
	...
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'FormInput':
				...
				return {ctor: '_Tuple2', _0: res, _1: _elm_lang$core$Platform_Cmd$none};
			case 'Submit':
				var credentials = A2(
			...
			case 'TryToken':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{msg: 'Attempting to load message...'}),
					_1: function () {
						var _p3 = model.token;
						if (_p3.ctor === 'Nothing') {
											...
											[
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														_elm_lang$html$Html_Attributes$id('uname'),
											...
											[
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														_elm_lang$html$Html_Attributes$class('form-control'),
														_elm_lang$html$Html_Attributes$id('pword'),
